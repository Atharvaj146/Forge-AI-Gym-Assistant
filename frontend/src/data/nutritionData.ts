...
export const mealPlans = [
  {
    ...
    principles: [
      ...
      "Prioritize 1.8–2.2g protein per kg bodyweight to support intense muscle protein synthesis.",
      "Time the majority of carbohydrates around workouts for peak performance and glycogen replenishment.",
      "Include healthy fats to support testosterone and anabolic hormone production.",
    ],
  },
  {
    id: "cutting",
    ...
    principles: [
      ...
      "Increase protein to 2.0–2.4g per kg to preserve lean mass while in a caloric deficit.",
      "Fill your plate with high-volume, low-calorie vegetables to stay satiated throughout the day.",
      "Keep dietary fats sufficient (≥20% of calories) to maintain hormone balance and joint health.",
    ],
  },
  {
    id: "maintenance",
    ...
    principles: [
      ...
      "Keep protein above 1.6g per kg to preserve muscle mass during periods of consistent training.",
      "Prioritize whole food micronutrient density — vitamins, minerals, and antioxidants for longevity.",
      "Focus on sustainable, enjoyable dietary patterns rather than rigid macronutrient tracking.",
    ],
  },
  {
    id: "athletic",
    ...
    principles: [
      ...
      "Include omega-3 sources like salmon and flaxseed to reduce exercise-induced inflammation and speed recovery.",
  ...
  },
  {
    ...
    emoji: "🎯",
    adjustment: "−600 kcal below TDEE",
    macroSplit: { protein: 40, carbs: 25, fat: 35 },
    keyFoods: ["Chicken Breast", "Eggs", "Broccoli", "Spinach", "Cottage Cheese", "Almonds"],
    principles: [
      "Create a more aggressive deficit of 500–700 kcal with high protein to minimize muscle loss during rapid fat loss.",
      "Include at least 2 resistance training sessions per week to preserve metabolic rate and lean mass.",
      "Optimize meal timing and frequency to manage hunger — high-protein, high-fiber meals every 3–4 hours.",
